...
Here you will find a collection notebooks we will be demonstrating and working through together for this year's Student Conference Python Workshop. The focus will be on some of [Unidata's Python tools](https://www.unidata.ucar.edu/projects/index.html#python), including [MetPy](https://unidata.github.io/MetPy/latest/) and [Siphon](https://unidata.github.io/siphon/latest/). We also have put together some pre-workshop materials that can help you get comfortable with some of the other Python libraries we rely on, like xarray and Cartopy.
